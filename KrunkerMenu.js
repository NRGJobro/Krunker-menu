...
// @version      1.0.0
// @description  Basic ass aimbot and visuals. Skidded from Zertalious, but no ads and better looking :)
// @author       NRG (Thank you Zertalious/Zert)
// @match        *://krunker.io/*
// @match        *://browserfps.com/*
// @exclude      *://krunker.io/social*
// @exclude      *://krunker.io/editor*
// @icon        https://cdn.discordapp.com/attachments/959570845565587466/1091160236481597520/20230324_223634.png
// @grant        none
...
<div class="dialog">${`<div class="close" onclick="this.parentNode.style.display='none';"></div>
	...
	<div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 5px;">
		<div class="btn" onclick="window.open('https://discord.gg/3va6BBPfzV', '_blank')">Discord</div>
		<div class="btn" onclick="window.open('https://github.com/NRGJobro', '_blank')">Github</div>
		<div class="btn" onclick="window.open('https://www.youtube.com/watch?v=a3Z7zEc7AXQ', '_blank')">NRG Dick Pics</div>
